...
#include "ControlledTest.generated.h"
...
UCLASS()
class VRATTEMPT_API AControlledTest : public AActor
{
	GENERATED_BODY()
...
public:
	...
	// OpenCV prototypes
	void UpdateTexture();
	FCSeedData MakeSeedData(cv::Point seed, cv::Scalar colour)
	{
		FCSeedData s;
		s.seed = seed;
		s.colour = colour;
	...
	std::vector<FCSeedData> seedList;
	...
	FORCEINLINE void ScreenMsg(const FString& Msg, const FCSeedData SeedPoint)
	{
